...
export const workExperiences = [
  ...
  },
  {
    ...
    points: [
      "Extended PCMDM, a past-conditioned diffusion model for coherent long-form 3D human motion generation, training a variant on a 10K+ annotation duet dance dataset that improved R-Precision Top-3 by 60% relative to the provided baseline.",
  ...
  },
  {
    ...
    result: "Improved model name-generation accuracy by 25% and output diversity by 40%.",
  },
  {
    id: 5,
    featured: false,
