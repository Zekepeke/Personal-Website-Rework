...
export const tier1Projects = [
  ...
  },
  {
    ...
    narrative: 'Extended an existing motion-diffusion model to generate two-person interactions instead of single-body motion, as an undergraduate researcher at Purdue.',
